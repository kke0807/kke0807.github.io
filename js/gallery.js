function gallery(){
	...
	imgbox.html("<img src='./img/gallery/test.png'>").find('img')
	...
	var gal_btn           = $('.gall_btn'),
			...
			list_length	      =	3, // li크기값 및 반복처리할 갯수 설정
	...
	gallerybtn.on('click', function(e){
     ...
     function startBtn(){ settingTime = setInterval('$(".gallery_btn_right").click()', 5000) };
      //setInterval 취소시키는 기능: clearInterval
      function stopBtn(){	clearInterval( settingTime )};
      startBtn();
      $('.thumbox').on({mouseenter:stopBtn ,mouseleave:startBtn});
}; // gallery
